...
import 'package:afc_mobile/teacher/infrastructure/data_sources/section_remote_provider.dart';
...
import 'package:afc_mobile/teacher/application/section_detail/section_detail_bloc.dart';
...
Future<void> $initGetIt(GetIt g, {String environment}) async {
  ...
  g.registerLazySingleton<CourseTeacherRepository>(() =>
      CourseTeacherRepository(
          ...
          sectionRemoteProvider: g<SectionRemoteProvider>()));
  ...
  g.registerLazySingleton<SectionDetailBloc>(() =>
      SectionDetailBloc(courseTeacherRepository: g<CourseTeacherRepository>()));
